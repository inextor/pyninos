class Item_Dictionary:
    ...
    def is_item(self,byte_list):
        return cmp(byte_list,self.byte_list) == 0;
...
class Dictionary_Builder:
    ...
    def add(self,byte_list):
        ...
        self.current_max_size = max(self.dictionary, key=lambda item: item.size )
        self.current_min_size = min(self.dictionary, key=lambda item: item.size )
